...
public class CombineModeCompactorSink implements Serializable {
    ...
    public CombineModeCompactorSink(
    ...
    public DataStreamSink<?> sinkFrom(
            DataStream<RowData> multiBucketTableSource, DataStream<AppendOnlyCompactionTask> unawareBucketTableSource) {
        ...
        SingleOutputStreamOperator<MultiTableCommittable> multiBucketTableRewriter =
                multiBucketTableSource
                        .transform(
                                String.format(
                                        "%s-%s",
                                        "Multi-Bucket-Table", WRITER_NAME),
