 ...
 *
 * <p>In-coming records are generated by sources built from {@link CombineCompactorSourceBuilder}.
 * The records will contain partition keys, bucket number, table name and database name.
 */
